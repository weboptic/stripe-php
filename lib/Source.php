 ...
 * @property \StripePhp\StripeObject $ach_debit
 ...
 * @property \StripePhp\StripeObject $code_verification
 ...
 * @property \StripePhp\StripeObject $multibanco
 * @property null|\StripePhp\StripeObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property \StripePhp\StripeObject $p24
 * @property \StripePhp\StripeObject $receiver
 * @property \StripePhp\StripeObject $redirect
 * @property \StripePhp\StripeObject $sepa_credit_transfer
 * @property \StripePhp\StripeObject $sepa_debit
 * @property \StripePhp\StripeObject $sofort
 * @property \StripePhp\StripeObject $source_order
 ...
 * @property \StripePhp\StripeObject $three_d_secure
 ...
 * @property \StripePhp\StripeObject $wechat
 */
class Source extends ApiResource
{
     ...
     *
     * @throws \StripePhp\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \StripePhp\Exception\ApiErrorException if the request fails
     *
     * @return \StripePhp\Source the detached source
     */
     ...
     * @throws \StripePhp\Exception\ApiErrorException if the request fails
     *
     * @return \StripePhp\Collection the list of source transactions
     */
    public function sourceTransactions($params = null, $opts = null)
    {
        $url = $this->instanceUrl() . '/source_transactions';
        list($response, $opts) = $this->_request('get', $url, $params, $opts);
        $obj = \StripePhp\Util\Util::convertToStripeObject($response, $opts);
     ...
     * @throws \StripePhp\Exception\ApiErrorException if the request fails
     *
     * @return \StripePhp\Source the verified source
     */
