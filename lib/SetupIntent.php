 ...
 * @property null|string|\StripePhp\StripeObject $application ID of the Connect application that created the SetupIntent.
 ...
 * @property null|string|\StripePhp\Customer $customer <p>ID of the Customer this SetupIntent belongs to, if one exists.</p><p>If present, the SetupIntent's payment method will be attached to the Customer on successful setup. Payment methods attached to other Customers cannot be used with this SetupIntent.</p>
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property null|\StripePhp\ErrorObject $last_setup_error The error encountered in the previous SetupIntent confirmation.
 * @property null|string|\StripePhp\SetupAttempt $latest_attempt The most recent SetupAttempt for this SetupIntent.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|string|\StripePhp\Mandate $mandate ID of the multi use Mandate generated by the SetupIntent.
 ...
 * @property null|\StripePhp\StripeObject $next_action If present, this property tells you what actions you need to take in order for your customer to continue payment setup.
 * @property null|string|\StripePhp\Account $on_behalf_of The account (if any) for which the setup is intended.
 * @property null|string|\StripePhp\PaymentMethod $payment_method ID of the payment method used with this SetupIntent.
 * @property null|\StripePhp\StripeObject $payment_method_options Payment-method-specific configuration for this SetupIntent.
 ...
 * @property null|string|\StripePhp\Mandate $single_use_mandate ID of the single_use Mandate generated by the SetupIntent.
...
class SetupIntent extends ApiResource
{
     ...
     *
     * @return \StripePhp\SetupIntent the canceled setup intent
     */
     ...
     * @throws \StripePhp\Exception\ApiErrorException if the request fails
     *
     * @return \StripePhp\SetupIntent the confirmed setup intent
     */
     ...
     * @throws \StripePhp\Exception\ApiErrorException if the request fails
     *
     * @return \StripePhp\SetupIntent the verified setup intent
     */
