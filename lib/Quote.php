 ...
 * @property \StripePhp\StripeObject $computed
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|string|\StripePhp\Customer $customer The customer which this quote belongs to. A customer is required before finalizing the quote. Once specified, it cannot be changed.
 * @property (string|\StripePhp\TaxRate)[] $default_tax_rates The tax rates applied to this quote.
 * @property null|string $description A description that will be displayed on the quote PDF.
 * @property (string|\StripePhp\Discount)[] $discounts The discounts applied to this quote.
 ...
 * @property null|\StripePhp\StripeObject $from_quote Details of the quote that was cloned. See the <a href="https://stripe.com/docs/quotes/clone">cloning documentation</a> for more details.
 * @property null|string $header A header that will be displayed on the quote PDF.
 * @property null|string|\StripePhp\Invoice $invoice The invoice that was created from this quote.
 * @property null|\StripePhp\StripeObject $invoice_settings All invoices will be billed using the specified settings.
 * @property \StripePhp\Collection<\StripePhp\LineItem> $line_items A list of items the customer is being quoted for.
 ...
 * @property null|string|\StripePhp\Account $on_behalf_of The account on behalf of which to charge. See the <a href="https://support.stripe.com/questions/sending-invoices-on-behalf-of-connected-accounts">Connect documentation</a> for details.
 * @property string $status The status of the quote.
 * @property \StripePhp\StripeObject $status_transitions
 * @property null|string|\StripePhp\Subscription $subscription The subscription that was created or updated from this quote.
 * @property \StripePhp\StripeObject $subscription_data
 * @property null|string|\StripePhp\SubscriptionSchedule $subscription_schedule The subscription schedule that was created or updated from this quote.
 * @property \StripePhp\StripeObject $total_details
 * @property null|\StripePhp\StripeObject $transfer_data The account (if any) the payments will be attributed to for tax reporting, and where funds from each payment will be transferred to for each of the invoices.
 */
class Quote extends ApiResource
{
     ...
     * @throws \StripePhp\Exception\ApiErrorException if the request fails
     *
     * @return \StripePhp\Quote the accepted quote
     */
     ...
     * @throws \StripePhp\Exception\ApiErrorException if the request fails
     *
     * @return \StripePhp\Quote the canceled quote
     */
     ...
     * @throws \StripePhp\Exception\ApiErrorException if the request fails
     *
     * @return \StripePhp\Quote the finalized quote
     */
     ...
     * @throws \StripePhp\Exception\ApiErrorException if the request fails
     *
     * @return \StripePhp\Collection<\StripePhp\Quote> list of LineItems
     */
