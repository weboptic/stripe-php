 ...
 * @property null|\StripePhp\StripeObject $amount_details Detailed breakdown of amount components. These amounts are denominated in <code>currency</code> and in the <a href="https://stripe.com/docs/currencies#zero-decimal">smallest currency unit</a>.
 ...
 * @property \StripePhp\BalanceTransaction[] $balance_transactions List of balance transactions associated with this authorization.
 * @property \StripePhp\Issuing\Card $card You can <a href="https://stripe.com/docs/issuing/cards">create physical or virtual cards</a> that are issued to cardholders.
 * @property null|string|\StripePhp\Issuing\Cardholder $cardholder The cardholder to whom this authorization belongs.
 ...
 * @property \StripePhp\StripeObject $merchant_data
 ...
 * @property null|\StripePhp\StripeObject $pending_request The pending authorization request. This field will only be non-null during an <code>issuing_authorization.request</code> webhook.
 * @property \StripePhp\StripeObject[] $request_history History of every time <code>pending_request</code> was approved/denied, either by you directly or by Stripe (e.g. based on your <code>spending_controls</code>). If the merchant changes the authorization by performing an <a href="https://stripe.com/docs/issuing/purchases/authorizations">incremental authorization</a>, you can look at this field to see the previous requests for the authorization.
 * @property string $status The current status of the authorization in its lifecycle.
 * @property \StripePhp\Issuing\Transaction[] $transactions List of <a href="https://stripe.com/docs/api/issuing/transactions">transactions</a> associated with this authorization.
 * @property \StripePhp\StripeObject $verification_data
 ...
 */
class Authorization extends \StripePhp\ApiResource
{
     ...
     *
     * @return \StripePhp\Issuing\Authorization the approved authorization
     */
     ...
     * @throws \StripePhp\Exception\ApiErrorException if the request fails
     *
     * @return \StripePhp\Issuing\Authorization the declined authorization
     */
