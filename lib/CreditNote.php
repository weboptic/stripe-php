 ...
 * @property string|\StripePhp\Customer $customer ID of the customer.
 * @property null|string|\StripePhp\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 * @property int $discount_amount The integer amount in %s representing the total amount of discount that was credited.
 * @property \StripePhp\StripeObject[] $discount_amounts The aggregate amounts calculated per discount for all line items.
 * @property string|\StripePhp\Invoice $invoice ID of the invoice.
 * @property \StripePhp\Collection<\StripePhp\CreditNoteLineItem> $lines Line items that make up the credit note
 ...
 * @property null|string|\StripePhp\Refund $refund Refund related to this credit note.
 ...
 * @property \StripePhp\StripeObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource
{
     ...
     *
     * @return \StripePhp\CreditNote the previewed credit note
     */
     ...
     * @throws \StripePhp\Exception\ApiErrorException if the request fails
     *
     * @return \StripePhp\CreditNote the voided credit note
     */
     ...
     * @throws \StripePhp\Exception\ApiErrorException if the request fails
     *
     * @return \StripePhp\Collection<\StripePhp\CreditNoteLineItem> the list of credit note line items
     */
