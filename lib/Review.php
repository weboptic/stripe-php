 ...
 * @property null|string|\StripePhp\Charge $charge The charge associated with this review.
 ...
 * @property null|\StripePhp\StripeObject $ip_address_location Information related to the location of the payment. Note that this information is an approximation and attempts to locate the nearest population center - it should not be used to determine a specific address.
 ...
 * @property string|\StripePhp\PaymentIntent $payment_intent The PaymentIntent ID associated with this review, if one exists.
 ...
 * @property null|\StripePhp\StripeObject $session Information related to the browsing session of the user who initiated the payment.
 */
class Review extends ApiResource
{
     ...
     *
     * @return \StripePhp\Review the approved review
     */
