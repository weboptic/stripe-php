 ...
 * @property \StripePhp\StripeObject $parameters
 ...
 * @property null|\StripePhp\File $result The file object representing the result of the report run (populated when <code>status=succeeded</code>).
 ...
 */
class ReportRun extends \StripePhp\ApiResource
{
