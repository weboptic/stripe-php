 ...
 * @property null|\StripePhp\StripeObject $business_profile Business information about the account.
 * @property null|string $business_type The business type.
 * @property \StripePhp\StripeObject $capabilities
 * @property bool $charges_enabled Whether the account can create live charges.
 * @property \StripePhp\StripeObject $company
 * @property \StripePhp\StripeObject $controller
 ...
 * @property \StripePhp\StripeObject $requirements
 * @property null|\StripePhp\StripeObject $settings Options for customizing how the account functions within Stripe.
 * @property \StripePhp\StripeObject $tos_acceptance
...
class Account extends ApiResource
{
     ...
     * @throws \StripePhp\Exception\ApiErrorException if the request fails
     *
     * @return \StripePhp\Collection<\StripePhp\Person> the list of persons
     */
     ...
     * @throws \StripePhp\Exception\ApiErrorException if the request fails
     *
     * @return \StripePhp\Account the rejected account
     */
     ...
     * @throws \StripePhp\Exception\ApiErrorException if the request fails
     *
     * @return \StripePhp\Collection<\StripePhp\Capability> the list of capabilities
     */
     ...
     * @throws \StripePhp\Exception\ApiErrorException if the request fails
     *
     * @return \StripePhp\Collection<\StripePhp\BankAccount|\StripePhp\Card> the list of external accounts (BankAccount or Card)
     */
