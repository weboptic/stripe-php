 ...
 * @property null|\StripePhp\StripeObject $last_error If present, this property tells you the last error encountered when processing the verification.
 * @property null|string|\StripePhp\Identity\VerificationReport $last_verification_report ID of the most recent VerificationReport. <a href="https://stripe.com/docs/identity/verification-sessions#results">Learn more about accessing detailed verification results.</a>
 ...
 * @property null|\StripePhp\StripeObject $redaction Redaction status of this VerificationSession. If the VerificationSession is not redacted, this field will be null.
 ...
 * @property null|\StripePhp\StripeObject $verified_outputs The user’s verified data.
 */
class VerificationSession extends \StripePhp\ApiResource
{
     ...
     *
     * @return \StripePhp\Identity\VerificationSession the canceled verification session
     */
     ...
     * @throws \StripePhp\Exception\ApiErrorException if the request fails
     *
     * @return \StripePhp\Identity\VerificationSession the redacted verification session
     */
