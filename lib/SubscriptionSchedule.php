 ...
 * @property null|\StripePhp\StripeObject $current_phase Object representing the start and end dates for the current phase of the subscription schedule, if it is <code>active</code>.
 * @property string|\StripePhp\Customer $customer ID of the customer who owns the subscription schedule.
 * @property \StripePhp\StripeObject $default_settings
 ...
 * @property \StripePhp\StripeObject[] $phases Configuration for the subscription schedule's phases.
 ...
 * @property null|string|\StripePhp\Subscription $subscription ID of the subscription managed by the subscription schedule.
 */
class SubscriptionSchedule extends ApiResource
{
     ...
     *
     * @return \StripePhp\SubscriptionSchedule the canceled subscription schedule
     */
     ...
     * @throws \StripePhp\Exception\ApiErrorException if the request fails
     *
     * @return \StripePhp\SubscriptionSchedule the released subscription schedule
     */
