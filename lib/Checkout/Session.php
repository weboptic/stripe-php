 ...
 * @property null|\StripePhp\StripeObject $after_expiration When set, provides configuration for actions to take if this Checkout Session expires.
 ...
 * @property null|\StripePhp\StripeObject $consent Results of <code>consent_collection</code> for this session.
 * @property null|\StripePhp\StripeObject $consent_collection When set, provides configuration for the Checkout Session to gather active consent from customers.
 * @property null|string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|string|\StripePhp\Customer $customer The ID of the customer for this Session. For Checkout Sessions in <code>payment</code> or <code>subscription</code> mode, Checkout will create a new customer object based on information provided during the payment flow unless an existing customer was provided when the Session was created.
 ...
 * @property null|\StripePhp\StripeObject $customer_details The customer details including the customer's tax exempt status and the customer's tax IDs. Only present on Sessions in <code>payment</code> or <code>subscription</code> mode.
 ...
 * @property \StripePhp\Collection<\StripePhp\LineItem> $line_items The line items purchased by the customer.
 ...
 * @property null|string|\StripePhp\PaymentIntent $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode.
 * @property null|string|\StripePhp\PaymentLink $payment_link The ID of the Payment Link that created this Session.
 * @property null|\StripePhp\StripeObject $payment_method_options Payment-method-specific configuration for the PaymentIntent or SetupIntent of this CheckoutSession.
 ...
 * @property \StripePhp\StripeObject $phone_number_collection
 * @property null|string $recovered_from The ID of the original expired Checkout Session that triggered the recovery flow.
 * @property null|string|\StripePhp\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode.
 * @property null|\StripePhp\StripeObject $shipping Shipping information for this Checkout Session.
 * @property null|\StripePhp\StripeObject $shipping_address_collection When set, provides configuration for Checkout to collect a shipping address from a customer.
 * @property \StripePhp\StripeObject[] $shipping_options The shipping rate options applied to this Session.
 * @property null|string|\StripePhp\ShippingRate $shipping_rate The ID of the ShippingRate for Checkout Sessions in <code>payment</code> mode.
 ...
 * @property null|string|\StripePhp\Subscription $subscription The ID of the subscription for Checkout Sessions in <code>subscription</code> mode.
 ...
 * @property \StripePhp\StripeObject $tax_id_collection
 * @property null|\StripePhp\StripeObject $total_details Tax and discount details for the computed total amount.
...
class Session extends \StripePhp\ApiResource
{
    ...
    use \StripePhp\ApiOperations\NestedResource;
     ...
     *
     * @return \StripePhp\Checkout\Session the expired session
     */
     ...
     * @throws \StripePhp\Exception\ApiErrorException if the request fails
     *
     * @return \StripePhp\Collection<\StripePhp\LineItem> the list of items
     */
