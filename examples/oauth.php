...
\StripePhp\Stripe::setApiKey(\getenv('STRIPE_SECRET_KEY'));
\StripePhp\Stripe::setClientId(\getenv('STRIPE_CLIENT_ID'));
...
if (isset($_GET['code'])) {
    ...
    try {
        $resp = \StripePhp\OAuth::token([
            'grant_type' => 'authorization_code',
            'code' => $code,
        ]);
    } catch (\StripePhp\Exception\OAuth\OAuthErrorException $e) {
    ...
    $url = \StripePhp\OAuth::authorizeUrl([
        'scope' => 'read_only',
    ]);
