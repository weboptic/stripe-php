...
trait TestHelper
{
    ...
    protected function setUpConfig()
    {
        ...
        $this->clientMock = $this->createMock('\StripePhp\HttpClient\ClientInterface');
        $this->streamingClientMock = $this->createMock('\StripePhp\HttpClient\StreamingClientInterface');
